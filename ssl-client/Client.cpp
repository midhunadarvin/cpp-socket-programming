// Build : g++ Client.cpp -o sslecho -lssl -lcrypto -I/opt/homebrew/opt/openssl/include --std=c++17
// Run   : ./sslecho <proxy-port> <server-host> <server-port>
/*
...
void sendRequest(SSL *ssl) {
    int result;
    const char* request = "POST /session/v1/login-request?request_id=cd1e0a0c-01ee-41fa-b7c3-39f30006afc7&databaseName=demo&schemaName=test&warehouse=compute_wh HTTP/1.1\r\nHost: ip24827.ap-southeast-1.snowflakecomputing.com\r\nUser-Agent: PythonConnector/3.7.1 (macOS-14.2.1-arm64-arm-64bit) CPython/3.12.2\r\nAccept-Encoding: gzip, deflate\r\naccept: application/snowflake\r\nConnection: keep-alive\r\nContent-Type: application/json\r\nContent-Encoding: gzip\r\nContent-Length: 354\r\nAuthorization: Snowflake Token=\"None\"\r\n\r\n\\U0000001";
    /* Send it to the server */
    if ((result = SSL_write(ssl, request, strlen(request))) <= 0) {
    ...
    std::cout << "SSL_read time : " << std::endl;
